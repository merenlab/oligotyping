...
pretty_names = {'output_directory': 'Output directory',
                ...
                'number_of_components': 'Number of entropy components used',
                's': 'Min number of datasets oligotype expected to appear',
                'a': 'Min % abundance of oligotype in at least one dataset',
                'bases_of_interest_locs': 'Bases of interest in the alignment',
                'num_datasets_in_fasta': 'Number of initial datasets',
