...
pretty_names = {'output_directory': 'Output directory',
                ...
                'total_seq': 'Number of sequences in FASTA',
                'number_of_components': 'Number of entropy components to use',
                's': 'Min number of datasets oligotype expected to appear',
                'a': 'Min % abundance of oligotype in at least one dataset',
                'bases_of_interest_locs': 'Bases of interest',
                'num_datasets_in_fasta': 'Number of datasets in FASTA',
                'num_unique_oligos': 'Number of unique oligotypes',
                ...
                'abundant_oligos_file_path': 'Abundant oligotypes file path',
                'num_sequences_after_qc': 'Number of sequences represented after quality filtering',
                'num_datasets_removed_after_qc': 'Datasets removed for having 0 oligotypes left after filtering',
                'oligos_nexus_file_path': 'NEXUS file for oligotypes',
                'environment_file_path': 'Environment file for Viamics/UniFrac analysis',
                'matrix_count_file_path': 'Data matrix (counts)',
                'matrix_percent_file_path': 'Data matrix (percents)',
